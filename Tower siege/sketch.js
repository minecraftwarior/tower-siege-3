...
ground2=new Ground(500,300,230,20)
...
box16=new Box(500,220,30,40)
thrower=new Thrower(100,200,20)
slingShot =new SlingShot (thrower.body,{x:130,y:200})
score=0;
...
Engine.update(engine);
  ...
  textSize(15);
  fill("orange")
  text("Press space to try again",700,350);
